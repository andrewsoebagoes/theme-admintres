...
<head>
	...
	<!-- Data table CSS -->
	<link href="<?= asset('theme/assets/vendors/bower_components/datatables/media/css/jquery.dataTables.min.css')?>" rel="stylesheet" type="text/css"/>
										...
										<div class="panel-body">
											<div class="streamline user-activity">
												<div class="sl-item">
													<a href="javascript:void(0)">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="<?= asset('theme/assets/img/user.png')?>" alt="avatar"/>
														</div>
												...
												<div class="sl-item">
													<a href="javascript:void(0)">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="<?= asset('theme/assets/img/user1.png')?>" alt="avatar"/>
														</div>
														<div class="sl-content">
															...
															<div class="activity-thumbnail">
																<img src="<?= asset('theme/assets/img/thumb-1.jpg')?>" alt="thumbnail"/>
																<img src="<?= asset('theme/assets/img/thumb-2.jpg')?>" alt="thumbnail"/>
																<img src="<?= asset('theme/assets/img/thumb-3.jpg')?>" alt="thumbnail"/>
															</div>
												...
												<div class="sl-item">
													<a href="javascript:void(0)">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="<?= asset('theme/assets/img/user2.png')?>" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<div class="sl-item">
													<a href="javascript:void(0)">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="<?= asset('theme/assets/img/user3.png')?>" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<div class="sl-item">
													<a href="javascript:void(0)">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="<?= asset('theme/assets/img/user4.png')?>" alt="avatar"/>
														</div>
														<div class="sl-content">
